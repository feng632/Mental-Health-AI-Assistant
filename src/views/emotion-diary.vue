    ...
    <div class="emotionDiary-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="iconeUrl" style="width: 60px; height: 60px;"></el-image>
                <h1 >情绪日记</h1>
            </div>
        </div>
        <div class="content"> 
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    ...
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryForm.diaryContent" placeholder="今天写点您的感想" type="textarea" :rows="5" maxlength="2000" show-word-limit></el-input>
                    </div>
                    <!-- 生活指标 -->
                    <div class="life-indicators">
                        ...
                        <div class="indicator-group">
                            ...
                            <el-select v-model="diaryForm.pressureLevel" placeholder="请选择压力水平">
...
const iconeUrl = new URL('@/assets/images/like.png', import.meta.url).href
</script>
