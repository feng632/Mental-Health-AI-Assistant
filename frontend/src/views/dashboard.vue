                ...
                <el-card>
                    <div class="card-content">
                        ...
                        <div class="info">
                            ...
                            <p class="subtitle-title">活跃用户数：{{ aiData.systemOverview?.activeUsers ?? 0 }}</p>
                        </div>
                    </div>
                </el-card>
            </el-col>
                    ...
                    <div class="chart-content">
                        <div class="consultation-stats">
                            ...
                            <div class="stat-item">
                                ...
                                <div class="stat-value">
                                    {{ aiData.consultationStats?.avgDurationMinutes ?? 0 }}分钟
                                </div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-label">
...
const iconUrl1 = '/src/assets/images/users.png'
const iconUrl2 = '/src/assets/images/like.png'
const iconUrl3 = '/src/assets/images/comments.png'
const iconUrl4 = '/src/assets/images/smile.png'
