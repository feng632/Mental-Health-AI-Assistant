        ...
        <div class="detail-content" v-if="currentDetail">
            ...
            <div class="detail-section">
                ...
                <el-descriptions :columns="2" border >
                    ...
                    <el-descriptions-item label="主要情绪">
                        <el-tag :type="getAiEmotionTagType(currentDetail.domainantEmotion)">{{currentDetail.dominantEmotion || '-' }}</el-tag>
                    </el-descriptions-item>
            ...
            <div class="detail-section">
                ...
                <div class="ai-analysis-result">
                    ...
                    <el-descriptions-item label="情绪性质">
                        <el-tag :type="aiData.isNegative?'danger':'success'">{{aiData.isNegative?'正常情绪':'负面情绪'}}</el-tag>
                    </el-descriptions-item>
            ...
            <div class="detail-section">
                ...
                <el-descriptions :column="2" border>
                    <el-descriptions-item label="创建时间">{{currentDetail.createdAt || '无'}}</el-descriptions-item>
