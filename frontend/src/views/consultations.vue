<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%;">
            <el-table-column  label="会话记录" width="100">
                <template #default="scope">
                    <el-avatar>{{ scope.row.userNickname }}</el-avatar>
                </template>
            </el-table-column>
            <el-table-column  label="情绪日志" width="">
                <template #default="scope">
            ...
            <el-table-column  label="操作" width="100%">
                <template #default="scope">
                    <el-button type="primary" text @click="viewSessionDetail(scope.row)">详细</el-button>
                </template>
            </el-table-column>
...
const handleSearch = () => { 
    getConsultationPage(pagination.value).then(res => {
